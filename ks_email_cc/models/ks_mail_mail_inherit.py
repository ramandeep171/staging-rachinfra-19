...
class MailMailInherit(models.Model):
    ...
    # NOTE (Odoo 19 migration): This is a near full copy of upstream `_send` with
    # minimal additions (injecting email_cc / email_bcc when building MIME message).
    # Re-check against core when upgrading to a newer 19.x to ensure no logic
    # (notifications, bounce handling, headers) changed upstream.
